...
export const Pagination = ({ className, dataCount }: PaginationProps) => {
  ...
  return (
    <div
      className={cn(
        "xs:gap-2 bg-background mx-auto flex w-fit items-center gap-1.5 rounded-full border px-3 py-2 shadow-md",
        className,
      )}
    >
      <Button
      ...
      {showJumpBackButton && (
        <>
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="group text-muted-foreground size-8 rounded-full"
          >
